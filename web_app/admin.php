<?php
	...
	if(isset($_POST['submit'])){
		...
		?>
		<script type="text/javascript">alert("Login ID or pasword Incorrect");</script>
		<?php
	}
	}
?>
...
<body>
	<div class="container" id="admin-header">
		 <h1 class="display-4" id="admin-head">Admin Login</h1>
		 <div class="container" id="login-box-admin">
			 <form method="post">
			  <div class="form-group">
			    <label for="exampleInputEmail1">Admin ID</label>
			    <input type="text" class="form-control" id="exampleInputEmail1" name="admin" placeholder="Enter Admin ID">
			  </div>
			  <div class="form-group">
